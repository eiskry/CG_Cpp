...
int main(int argc, char** argv) {
	...
	printf("(2)\n");
	Vector2d v_0(5.0, 2.0);
	Vector2d v_1(3.2, -2.3);
	Vector2d v_2(4.1, 9.2);
	Vector2d v_3(-2.0, 4.0);
	Vector2d v_4(0.0, -2.7);

	vec.push_back(v_0); // 配列の末尾に v0 を追加
	vec.push_back(v_1); // 配列の末尾に v1 を追加
	vec.push_back(v_2); // 配列の末尾に v2 を追加
	vec.push_back(v_3); // 配列の末尾に v3 を追加
	vec.push_back(v_4); // 配列の末尾に v4 を追加
